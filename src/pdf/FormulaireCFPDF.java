...
public class FormulaireCFPDF {
    ...
    public FormulaireCFPDF() throws IOException {
        this(FormulaireCFPDF.class.getResourceAsStream("FormulaireCF2017.pdf"));
    }

    public FormulaireCFPDF(InputStream in) throws IOException {
    ...
    public static void main(String[] args) {
        System.out.println(new File(FormulaireCFPDF.class.getResource("FormulaireCF2017.pdf").getFile()));
    }
}
